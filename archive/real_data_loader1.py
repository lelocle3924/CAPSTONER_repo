...
class RealDataLoader:
    def __init__(self):
        ...
        self.default_fleet = [
            VehicleType(0, "MC",  100,  0.12, 50, 50,  10, 1, 50),
            VehicleType(1, "AUV", 800,  2.5,  50, 500, 25, 3, 20),
            VehicleType(2, "4w",  1500, 5.0,  50, 1000, 40, 5, 15),
            VehicleType(3, "6w",  3000, 12.0, 50, 2000, 60, 7, 10),
            VehicleType(4, "10w", 12000, 30.0, 50, 3500, 80, 9, 5),
            VehicleType(5, "40ft", 28000, 60.0, 50, 5000, 100, 11, 2)
        ]
