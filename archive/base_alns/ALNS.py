...
from base_alns.Outcome import Outcome
from base_alns.Result import Result
from base_alns.State import State
from base_alns.Statistics import Statistics
from base_alns.accept import AcceptanceCriterion
from base_alns.select import OperatorSelectionScheme
from base_alns.stop import StoppingCriterion

# USED WHEN RUN BASELINE ALNS
...
class ALNS:
    ...
    def iterate(
        ...
        **kwargs
        ...
        while not stop(self._rng, best, curr):
            ...
            # print(f"d_idx: {d_idx}, r_idx: {r_idx}")
    ...
    def iterate_with_ppo(
        ...
        **kwargs
        ...
        best, cand, outcome = self._eval_cand(
            accept, cur_best, cur_solution, cand, **kwargs
        )
    ...
    def reset_opt(self):
        ...
        """
        logger.debug("Resetting ALNS operators.")
        self._d_ops.clear()
        self._r_ops.clear()
